...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  const description = `Auto-apply to ${b.name} jobs with an AI-tailored resume. Eligibility-checked and verified submitted. Free tier + 30-day money-back guarantee.`;
