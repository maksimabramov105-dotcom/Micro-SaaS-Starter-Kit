...
async def generate_cover_letter(
    ...
    prompt = (
        ...
        f"- Start directly with the greeting (e.g. \"Dear Hiring Manager,\"), then express interest and mention the specific role\n"
        f"- Body: Highlight 2-3 most relevant skills/experiences that match the job\n"
        f"- Closing: Call to action, express eagerness for an interview, then a brief sign-off and the candidate's name\n"
        f"- NO letterhead, address, date, phone or email lines; NO bracketed placeholders like [Your Address] or [Date]; no square brackets at all\n"
